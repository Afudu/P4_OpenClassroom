...
# Database
For storing and loading the data, the application uses TinyDb, a document oriented database, in json format saved in the 'dbase' folder in the root of the repository.
